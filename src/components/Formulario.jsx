  ...
  return (
      <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form 
            ...
            className ="bg-blue-400 shadow-md rounded-lg py-10 px-5 mb-10">
           
            {error && <Error>Todos los campos son obligatprios</Error> }
           <div className = "mb-5">
          ...
          <div className="mb-5">
            ...
            <input 
            type="submit"
            className=" bg-slate-800 w-full p-3 text-white uppercase font-bold  transition-all rounded-lg"
            value={paciente.id ? 'Editar Pacinte' : 'Agregar Paciente'}
